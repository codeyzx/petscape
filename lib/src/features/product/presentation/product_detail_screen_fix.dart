...
class ProductDetailScreenFix extends ConsumerStatefulWidget {
  final String usersId;
  final Product product;
  const ProductDetailScreenFix({Key? key, required this.product, required this.usersId}) : super(key: key);

  @override
  ConsumerState<ProductDetailScreenFix> createState() => _ProductDetailScreenFixState();
}

class _ProductDetailScreenFixState extends ConsumerState<ProductDetailScreenFix> {
